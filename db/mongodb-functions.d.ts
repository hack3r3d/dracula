...
export declare const create: (client: MongoClient, config: CollectionConfig, counter: CounterInput) => Promise<import("mongodb").InsertOneResult<Counter>>;
export declare const read: (client: MongoClient, config: CollectionConfig, collatorId: Record<string, unknown>) => Promise<Counter[]>;
/**
 * Calculate the total count for records that match the `countOn` meta field.
 */
export declare const compute: (client: MongoClient, config: CollectionConfig, countOn: string) => Promise<number>;
/**
